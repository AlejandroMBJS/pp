---
name: mobile-detection-bottomnav
description: Crear sistema base de detección de dispositivo móvil y componente MobileBottomNav que reemplaza el sidebar en pantallas menores a 768px
